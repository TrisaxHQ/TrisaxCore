# Support for Output Descriptors in Trisax Core

Since Trisax Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `trsx1...` for mainnet or `ttrsx1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Trisax Core wallets, a convenience function `combo` is
