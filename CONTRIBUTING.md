Contributing to Trisax Core
============================

The Trisax Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Trisax Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/trisax-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to trisax-qt
...
The following applies to code changes to the Trisax Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Trisax
Network Protocol consensus changes.

Whether a pull request is merged into Trisax Core rests with the project merge
...
Patches that change Trisax consensus rules are considerably more involved than
...
Where a patch set proposes to change the Trisax consensus, it must have been
...
The project leader is the release manager for each Trisax Core release.
