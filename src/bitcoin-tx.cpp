...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " trisax-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  trisax-tx [options] <hex-tx> [commands]  Update hex-encoded trisax transaction\n" +
            "or:     trisax-tx [options] -create [commands]   Create hex-encoded trisax transaction\n" +
            "\n";
