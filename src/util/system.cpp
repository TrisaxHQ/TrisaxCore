...
const char * const BITCOIN_CONF_FILENAME = "trisax.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Trisax";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Trisax";
#else
    // Unix-like
    return pathRet / ".trisax";
#endif
#endif
}
