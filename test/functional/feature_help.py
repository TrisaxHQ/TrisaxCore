...
"""Verify that starting trisax with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start trisax with -h for help text")
        ...
        self.log.info("Start trisax with -version for version information")
        ...
        self.log.info("Start trisaxd with -fakearg to make sure it does not start")
