...
bech32_templates = [
  ...
  ('trsx',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('trsx',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('trsx',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('trsx',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('ttrsx',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('ttrsx',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('ttrsx',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('ttrsx',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('ttrsx',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('ttrsx',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('ttrsx',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('ttrsx',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rtrsx',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rtrsx',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rtrsx',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rtrsx', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('ttrsx',   17, 32, Encoding.BECH32M, False, False, False),
  ('rtrsx',  3,  1, Encoding.BECH32M, False, False, False),
  ('trsx',   15, 41, Encoding.BECH32M, False, False, False),
  ('ttrsx',    0, 16, Encoding.BECH32,  False, False, False),
  ('rtrsx',  0, 32, Encoding.BECH32,  True,  False, False),
  ('trsx',    0, 16, Encoding.BECH32,  True,  False, False),
  ('ttrsx',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rtrsx',  0, 20, Encoding.BECH32,  False, False, True),
  ('trsx',    0, 20, Encoding.BECH32M, False, False, False),
  ('ttrsx',    0, 32, Encoding.BECH32M, False, False, False),
  ('rtrsx',  0, 20, Encoding.BECH32M, False, False, False),
  ('trsx',    1, 32, Encoding.BECH32,  False, False, False),
  ('ttrsx',    2, 16, Encoding.BECH32,  False, False, False),
  ('rtrsx', 16, 20, Encoding.BECH32,  False, False, False),
]
